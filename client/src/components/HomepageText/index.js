    ...
    return(
        ...
        <div className="card col-md-11
         m-5" id="textCard">
            ...
            <br/>
            <p>Wanting to create is one of the purest natural desires that each of us hold. However, with the hectic pace of day-to-day life, it's easy to forget the special feeling of creating something unique.</p>
